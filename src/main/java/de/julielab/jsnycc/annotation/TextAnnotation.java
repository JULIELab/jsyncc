...
public class TextAnnotation
{
	...
	static HashSet<String> tokenTypes = new HashSet<String>();

	static Integer countSentences = 0;
	static Integer countTokens = 0;
	static Integer countTokenTypes = 0;
	...
	public void setTokenTypes(HashSet<String> tokenTypes) {
		TextAnnotation.tokenTypes = tokenTypes;
	}
	...
	public Integer getCountTokenTypes() {
		return countTokenTypes;
	}
	public void setCountTokenTypes(Integer countTokenTypes) {
		TextAnnotation.countTokenTypes = countTokenTypes;
	}
}
